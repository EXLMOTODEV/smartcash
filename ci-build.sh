...
cat /proc/cpuinfo
make V=1 -j3
tar -czf smartcash-qt.gz src/qt/smartcash-qt.exe
curl -sS --upload-file smartcash-qt.gz https://transfer.sh/smartcash-qt.gz && echo -e '\n'
